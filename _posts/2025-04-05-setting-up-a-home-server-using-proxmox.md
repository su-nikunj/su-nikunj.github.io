...
> By default the Backups share will give a permission denied in Proxmox. To fix this, edit the Backups share, select Advanced options and change the Maproot User and Maproot Group to root.
{: .prompt-danger}
